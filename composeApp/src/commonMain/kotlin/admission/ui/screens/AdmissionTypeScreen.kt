...
import core.ui.screens.itemlist.ItemAdmissionType
...
fun AdmissionTypeScreen(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Text(
            ...
            text = "${stringResource(SharedRes.strings.select_the_type_of_admission)} ${
                stringResource(
        ...
        LazyVerticalGrid(
            ...
            item {
                ItemAdmissionType(
                    text = stringResource(SharedRes.strings.emergencies),
            ...
            item {
                ItemAdmissionType(
                    text = stringResource(SharedRes.strings.consultations),
